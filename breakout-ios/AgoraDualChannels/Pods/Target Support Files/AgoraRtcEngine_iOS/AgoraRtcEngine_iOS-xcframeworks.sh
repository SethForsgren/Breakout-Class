...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraAIDenoiseExtension.xcframework" "AgoraAIDenoiseExtension" "framework" "ios-x86_64-simulator" "ios-armv7_arm64"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraRtcKit.xcframework" "AgoraRtcKit" "framework" "ios-armv7_arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/Agoraffmpeg.xcframework" "Agoraffmpeg" "framework" "ios-x86_64-simulator" "ios-armv7_arm64"
